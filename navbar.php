...
<nav id="sidebar" class='mx-lt-5 bg-success'style="margin-top:35px" >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=receiving" class="nav-item nav-receiving nav-manage_receiving"><span class='icon-field'><i class="fa fa-file-alt"></i></span> Restocking</a>
